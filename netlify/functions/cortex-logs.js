...
const { guard, assertTenantAccess, HEADERS, makeHeaders } = require('./middleware');
...
exports.handler = async (event) => {
  ...
  // FIX v49: guard ANTES do método check — sem token retorna 401, não 405
  ...
  try {
    ...
    // FIX TENANT ISOLATION: valida que caller pertence ao tenantId
    ...
    console.error('[CORTEX-LOGS] ❌', 'Internal error');
